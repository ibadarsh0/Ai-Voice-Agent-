...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - TUTORIAL BY Adarsh Bharwaj")
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "Adarsh Bhardwaj Cafe".
...
def save_order_to_json(order: OrderState) -> str:
    ...
    try:
        ...
        print("📺 Tutorial by: Adarsh Bhardwaj!")
        print("✅" * 30 + "\n")
...
async def entrypoint(ctx: JobContext):
    ...
    print("👨‍⚕️ Tutorial by Adarsh Bhardwaj")
...
if __name__ == "__main__":
    ...
    print("👨‍⚕️ Developed from Adarsh Bhardwaj Tutorial")
    print("⚡" * 25 + "\n")
