...
# 👨‍⚕️ "Adarsh Bhardwaj - Store" - Auto-Lead Capture Agent
...
print("📚 SELLING: Adarsh's Cloud & AI Courses")
...
# Default FAQ data for "Adarsh Bhardwaj - Store"
DEFAULT_FAQ = [
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Adarsh Bhardwaj Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Adarsh Bhardwaj and email you." (Don't hallucinate prices).
            """,
